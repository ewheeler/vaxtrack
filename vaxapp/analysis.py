...
class Analysis(object):
    ...
    def plot(self):
        ...
        try:
            ...
            fig.text(0,0,_(colophon), fontsize=8)
            ...
            if self.display_forecast_projection:
                ...
                ax.plot_date(projected_ff_dates, projected_ff_levels, '--',\
                    ...
                    label=_('projected stock based on forecast'))
            ...
            if self.display_purchased_projection:
                ...
                label=_('projected stock based on placed POs'))
            ...
            if self.display_theoretical_forecast:
                ...
                label=_('theoretical stock based on forecast'))
            ...
            if self.display_adjusted_theoretical_forecast:
                ...
                label=_('theoretical stock adjusted with deliveries'))
