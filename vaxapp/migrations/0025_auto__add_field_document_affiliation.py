...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Document.affiliation'
        db.add_column('vaxapp_document', 'affiliation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Document.affiliation'
        db.delete_column('vaxapp_document', 'affiliation_id')
