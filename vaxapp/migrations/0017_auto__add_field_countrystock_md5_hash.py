...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CountryStock.md5_hash'
        db.add_column('vaxapp_countrystock', 'md5_hash', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CountryStock.md5_hash'
        db.delete_column('vaxapp_countrystock', 'md5_hash')
