...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AltVaccine.country'
        db.add_column('vaxapp_altvaccine', 'country', self.gf('django.db.models.fields.related.ForeignKey')(default='ML', to=orm['vaxapp.Country']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AltVaccine.country'
        db.delete_column('vaxapp_altvaccine', 'country_id')
