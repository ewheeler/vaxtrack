...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Document.date_reverted'
        db.delete_column('vaxapp_document', 'date_reverted')

        # Adding field 'Document.date_revert_start'
        db.add_column('vaxapp_document', 'date_revert_start', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Document.date_revert_end'
        db.add_column('vaxapp_document', 'date_revert_end', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Document.date_reverted'
        db.add_column('vaxapp_document', 'date_reverted', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Document.date_revert_start'
        db.delete_column('vaxapp_document', 'date_revert_start')

        # Deleting field 'Document.date_revert_end'
        db.delete_column('vaxapp_document', 'date_revert_end')
    ...
    models = {
        ...
        'vaxapp.document': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.utcnow'}),
            'date_data_begin': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'date_data_end': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'date_exception': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'date_process_end': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'date_process_start': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'date_queued': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'date_revert_end': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'date_revert_start': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'date_stored': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'reverted_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'reverted_document'", 'null': 'True', 'to': "orm['auth.User']"}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'U'", 'max_length': '1'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'uploaded_document'", 'to': "orm['auth.User']"}),
