...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Document.date_data_begin'
        db.add_column('vaxapp_document', 'date_data_begin', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Document.date_data_end'
        db.add_column('vaxapp_document', 'date_data_end', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Document.date_data_begin'
        db.delete_column('vaxapp_document', 'date_data_begin')

        # Deleting field 'Document.date_data_end'
        db.delete_column('vaxapp_document', 'date_data_end')
    ...
    models = {
        ...
        'vaxapp.document': {
            ...
            'date_process_start': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'date_queued': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'date_reverted': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'date_stored': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
