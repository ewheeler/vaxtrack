...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VaccineGroup.slug'
        db.add_column('vaxapp_vaccinegroup', 'slug', self.gf('django.db.models.fields.CharField')(max_length=160, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'VaccineGroup.slug'
        db.delete_column('vaxapp_vaccinegroup', 'slug')
