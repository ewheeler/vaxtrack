...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('vaxapp_document', (
            ...
            ('remote_document', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
        ...
        db.send_create_signal('vaxapp', ['Document'])


    def backwards(self, orm):
        
        # Deleting model 'Document'
        db.delete_table('vaxapp_document')
