...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CountryStockStats.has_stock_data'
        db.add_column('vaxapp_countrystockstats', 'has_stock_data', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'CountryStockStats.has_forecast_data'
        db.add_column('vaxapp_countrystockstats', 'has_forecast_data', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'CountryStockStats.has_delivery_data'
        db.add_column('vaxapp_countrystockstats', 'has_delivery_data', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CountryStockStats.has_stock_data'
        db.delete_column('vaxapp_countrystockstats', 'has_stock_data')

        # Deleting field 'CountryStockStats.has_forecast_data'
        db.delete_column('vaxapp_countrystockstats', 'has_forecast_data')

        # Deleting field 'CountryStockStats.has_delivery_data'
        db.delete_column('vaxapp_countrystockstats', 'has_delivery_data')
