...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Document.reverted_by'
        db.add_column('vaxapp_document', 'reverted_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='reverted_document', null=True, to=orm['auth.User']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Document.reverted_by'
        db.delete_column('vaxapp_document', 'reverted_by_id')
