...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CountryStockStats'
        db.create_table('vaxapp_countrystockstats', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('countrystock', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vaxapp.CountryStock'])),
            ('analyzed', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('reference_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('consumed_in_year', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True)),
            ('actual_cons_rate', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True)),
            ('annual_demand', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True)),
            ('three_month_buffers', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True)),
            ('nine_month_buffers', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True)),
            ('est_daily_cons', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('days_of_stock', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('doses_delivered_this_year', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('doses_on_orders', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('demand_for_period', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('percent_coverage', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ))
        db.send_create_signal('vaxapp', ['CountryStockStats'])


    def backwards(self, orm):
        
        # Deleting model 'CountryStockStats'
        db.delete_table('vaxapp_countrystockstats')
    ...
    models = {
        ...
        'vaxapp.countrystockstats': {
            ...
            'actual_cons_rate': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'analyzed': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'annual_demand': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'consumed_in_year': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'countrystock': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['vaxapp.CountryStock']"}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nine_month_buffers': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            ...
            'three_month_buffers': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'})
        },
        'vaxapp.document': {
