...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Document.local_document'
        db.alter_column('vaxapp_document', 'local_document', self.gf('django.db.models.fields.files.FileField')(default='/tmp/', max_length=100))


    def backwards(self, orm):
        
        # Changing field 'Document.local_document'
        db.alter_column('vaxapp_document', 'local_document', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
    ...
    models = {
        ...
        'vaxapp.document': {
            ...
            'local_document': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
