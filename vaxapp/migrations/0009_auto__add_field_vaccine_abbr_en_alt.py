...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Vaccine.abbr_en_alt'
        db.add_column('vaxapp_vaccine', 'abbr_en_alt', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Vaccine.abbr_en_alt'
        db.delete_column('vaxapp_vaccine', 'abbr_en_alt')
