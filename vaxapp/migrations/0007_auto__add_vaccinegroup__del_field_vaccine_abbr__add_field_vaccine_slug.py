...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'VaccineGroup'
        db.create_table('vaxapp_vaccinegroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('abbr_en', self.gf('django.db.models.fields.CharField')(max_length=160, null=True, blank=True)),
            ('abbr_fr', self.gf('django.db.models.fields.CharField')(max_length=160, null=True, blank=True)),
        ))
        db.send_create_signal('vaxapp', ['VaccineGroup'])

        # Deleting field 'Vaccine.abbr'
        db.delete_column('vaxapp_vaccine', 'abbr')

        # Adding field 'Vaccine.slug'
        db.add_column('vaxapp_vaccine', 'slug', self.gf('django.db.models.fields.CharField')(max_length=160, null=True, blank=True), keep_default=False)

        # Adding field 'Vaccine.group'
        db.add_column('vaxapp_vaccine', 'group', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['vaxapp.VaccineGroup']), keep_default=False)

        # Adding field 'Vaccine.abbr_en'
        db.add_column('vaxapp_vaccine', 'abbr_en', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)

        # Adding field 'Vaccine.abbr_fr'
        db.add_column('vaxapp_vaccine', 'abbr_fr', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)

        # Adding field 'Vaccine.abbr_fr_alt'
        db.add_column('vaxapp_vaccine', 'abbr_fr_alt', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'VaccineGroup'
        db.delete_table('vaxapp_vaccinegroup')
        ...
        # Deleting field 'Vaccine.slug'
        db.delete_column('vaxapp_vaccine', 'slug')

        # Deleting field 'Vaccine.group'
        db.delete_column('vaxapp_vaccine', 'group_id')

        # Deleting field 'Vaccine.abbr_en'
        db.delete_column('vaxapp_vaccine', 'abbr_en')

        # Deleting field 'Vaccine.abbr_fr'
        db.delete_column('vaxapp_vaccine', 'abbr_fr')

        # Deleting field 'Vaccine.abbr_fr_alt'
        db.delete_column('vaxapp_vaccine', 'abbr_fr_alt')
    ...
    models = {
        ...
        'vaxapp.vaccine': {
            ...
            'abbr_en': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'abbr_fr': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'abbr_fr_alt': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
