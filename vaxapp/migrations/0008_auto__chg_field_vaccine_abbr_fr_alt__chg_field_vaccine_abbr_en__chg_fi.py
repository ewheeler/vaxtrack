...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Vaccine.abbr_fr_alt'
        db.alter_column('vaxapp_vaccine', 'abbr_fr_alt', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'Vaccine.abbr_en'
        db.alter_column('vaxapp_vaccine', 'abbr_en', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'Vaccine.abbr_fr'
        db.alter_column('vaxapp_vaccine', 'abbr_fr', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))


    def backwards(self, orm):
        
        # Changing field 'Vaccine.abbr_fr_alt'
        db.alter_column('vaxapp_vaccine', 'abbr_fr_alt', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Vaccine.abbr_en'
        db.alter_column('vaxapp_vaccine', 'abbr_en', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Vaccine.abbr_fr'
        db.alter_column('vaxapp_vaccine', 'abbr_fr', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
