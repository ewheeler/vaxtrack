...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('vaxapp_userprofile', 'lang', self.gf('django.db.models.fields.CharField')(default='en', max_length=10), keep_default=False)

        # Adding field 'UserProfile.alert_emails'
        db.add_column('vaxapp_userprofile', 'alert_emails', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Changing field 'UserProfile.user'
        db.alter_column('vaxapp_userprofile', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))

        # Adding unique constraint on 'UserProfile', fields ['user']
        db.create_unique('vaxapp_userprofile', ['user_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'UserProfile', fields ['user']
        db.delete_unique('vaxapp_userprofile', ['user_id'])

        # Deleting field 'UserProfile.lang'
        db.delete_column('vaxapp_userprofile', 'lang')

        # Deleting field 'UserProfile.alert_emails'
        db.delete_column('vaxapp_userprofile', 'alert_emails')

        # Changing field 'UserProfile.user'
        db.alter_column('vaxapp_userprofile', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
