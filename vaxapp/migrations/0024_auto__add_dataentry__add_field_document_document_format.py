...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('vaxapp_dataentry', (
            ...
            ('date_stored', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('date_queued', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('date_process_start', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('date_process_end', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('date_exception', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.utcnow)),
        ))
        db.send_create_signal('vaxapp', ['DataEntry'])

        # Adding field 'Document.document_format'
        db.add_column('vaxapp_document', 'document_format', self.gf('django.db.models.fields.CharField')(default='TK', max_length=12), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'DataEntry'
        db.delete_table('vaxapp_dataentry')

        # Deleting field 'Document.document_format'
        db.delete_column('vaxapp_document', 'document_format')
