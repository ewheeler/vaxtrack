...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AltVaccine'
        db.create_table('vaxapp_altvaccine', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('vaccine', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vaxapp.Vaccine'])),
            ('alternate', self.gf('django.db.models.fields.CharField')(max_length=160)),
        ))
        db.send_create_signal('vaxapp', ['AltVaccine'])

        # Adding model 'AltCountry'
        db.create_table('vaxapp_altcountry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('country', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vaxapp.Country'])),
            ('alternate', self.gf('django.db.models.fields.CharField')(max_length=160)),
        ))
        db.send_create_signal('vaxapp', ['AltCountry'])


    def backwards(self, orm):
        
        # Deleting model 'AltVaccine'
        db.delete_table('vaxapp_altvaccine')

        # Deleting model 'AltCountry'
        db.delete_table('vaxapp_altcountry')
