...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Alert.analyzed'
        db.add_column('vaxapp_alert', 'analyzed', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Alert.reference_date'
        db.add_column('vaxapp_alert', 'reference_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Alert.risk'
        db.add_column('vaxapp_alert', 'risk', self.gf('django.db.models.fields.CharField')(default='U', max_length=2, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Alert.analyzed'
        db.delete_column('vaxapp_alert', 'analyzed')

        # Deleting field 'Alert.reference_date'
        db.delete_column('vaxapp_alert', 'reference_date')

        # Deleting field 'Alert.risk'
        db.delete_column('vaxapp_alert', 'risk')
