...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Alert'
        db.create_table('vaxapp_alert', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('countrystock', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vaxapp.CountryStock'])),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=160, null=True, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(default='U', max_length=2, null=True, blank=True)),
        ))
        db.send_create_signal('vaxapp', ['Alert'])


    def backwards(self, orm):
        
        # Deleting model 'Alert'
        db.delete_table('vaxapp_alert')
