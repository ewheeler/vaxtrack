...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CountryStockStats.three_month_buffers'
        db.delete_column('vaxapp_countrystockstats', 'three_month_buffers_id')

        # Deleting field 'CountryStockStats.nine_month_buffers'
        db.delete_column('vaxapp_countrystockstats', 'nine_month_buffers_id')

        # Adding field 'CountryStockStats.three_by_year'
        db.add_column('vaxapp_countrystockstats', 'three_by_year', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='three_by_year', null=True, to=orm['vaxapp.Dicty']), keep_default=False)

        # Adding field 'CountryStockStats.nine_by_year'
        db.add_column('vaxapp_countrystockstats', 'nine_by_year', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='nine_by_year', null=True, to=orm['vaxapp.Dicty']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'CountryStockStats.three_month_buffers'
        db.add_column('vaxapp_countrystockstats', 'three_month_buffers', self.gf('django.db.models.fields.related.ForeignKey')(related_name='three_month_buffers', null=True, to=orm['vaxapp.Dicty'], blank=True), keep_default=False)

        # Adding field 'CountryStockStats.nine_month_buffers'
        db.add_column('vaxapp_countrystockstats', 'nine_month_buffers', self.gf('django.db.models.fields.related.ForeignKey')(related_name='nine_month_buffers', null=True, to=orm['vaxapp.Dicty'], blank=True), keep_default=False)

        # Deleting field 'CountryStockStats.three_by_year'
        db.delete_column('vaxapp_countrystockstats', 'three_by_year_id')

        # Deleting field 'CountryStockStats.nine_by_year'
        db.delete_column('vaxapp_countrystockstats', 'nine_by_year_id')
