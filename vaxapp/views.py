...
def chart_country(req, country_pk=None, vaccine_abbr=None):
    ...
    try:
        ...
        title = "%s %s" % (country_stock.country.printable_name, country_stock.vaccine.abbr)
        fig.suptitle(title, fontsize=18)
        colophon = "Generated by VaxTrack on %s (GMT -5)" % (str(datetime.datetime.now().strftime("%A, %d. %B %Y %I:%M%p")))
