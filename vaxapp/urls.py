...
urlpatterns = patterns('',
    ...
    url(r'^charts/(?P<country_pk>\w+)/(?P<group_slug>\w+)/(?P<chart_opts>\w+).png$', views.get_chart, name="chart-country"),
    url(r'^charts/(?P<country_pk>\w+)/(?P<group_slug>\w+)/.png$', views.get_chart, name="chart-country"),
